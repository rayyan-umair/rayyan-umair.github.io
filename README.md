...
|:---|:---|:---|:---:|
| NetRaptor | Modular network intelligence & threat hunting system. 9 integrated tools across 3 clusters -  recon, analysis, and response. Architecture-first build, no SaaS dependencies. | Python · Scapy · Nmap API · Sigma · SQLite · REST · MITRE ATT&CK |  Active |
